...
def create_dataset(settings_dataset: MutableMapping[str, Any],
    ...
    csv_dev, csv_val, csv_eva = get_annotations_files(
...
def extract_features(root_dir: str,
    ...
    dir_val = dir_output.joinpath(
        settings_data['audio_dirs']['validation'])
    ...
    dir_output_val = dir_root.joinpath(
        settings_data['features_dirs']['output'],
        settings_data['features_dirs']['validation'])
    ...
    dir_output_val.mkdir(parents=True, exist_ok=True)
    ...
    for data_file_name in filter(
            ...
            chain(dir_dev.iterdir(), dir_val.iterdir(), dir_eva.iterdir())):
        ...
        elif data_file_name.parent.name == settings_data['audio_dirs']['validation']:
            parent_path = dir_output_val
        else:
            parent_path = dir_output_eva
