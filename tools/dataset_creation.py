...
def get_annotations_files(settings_ann: MutableMapping[str, Any],
                          dir_ann: Path)\
        -> Tuple[List[MutableMapping[str, Any]],
    ...
    csv_development = read_csv_file(
        ...
        base_dir=dir_ann)
    csv_validation = read_csv_file(
        file_name=settings_ann['validation_file'],
        base_dir=dir_ann)
    ...
    for csv_entry in chain(csv_development, csv_validation, csv_evaluation):
    ...
    return csv_development, csv_validation, csv_evaluation
